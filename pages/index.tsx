...
const data: QAItem[] = [
  ...
  { question: "What does 'overdue' mean?", answer: "Past the deadline", vietnamese: "Quá hạn" },
  ...
  { question: "What does 'assassination' mean?", answer: "An action to kill someone", vietnamese: "Ám sát" },
  ...
  { question: "What is a 'police unit'?", answer: "A group protects community", vietnamese: "Đơn vị cảnh sát" },
  { question: "What is a 'military unit'?", answer: "A group that works for government", vietnamese: "Đơn vị quân đội" },
  { question: "What is a 'vigilante unit'?", answer: "Acts like police, but are not the police", vietnamese: "Nhóm tự xử" },
  { question: "What is a 'paramilitary unit'?", answer: "Like military, but not official", vietnamese: "Nhóm bán quân sự" },
  { question: "What is a 'rebel group'?", answer: "Group fights the government", vietnamese: "Nhóm nổi dậy" },
  { question: "What is a 'self-defense unit'?", answer: "Group protects in place", vietnamese: "Nhóm tự vệ" },
  { question: "What is a 'guerrilla group'?", answer: "Group uses weapons to attack government", vietnamese: "Nhóm du kích" },
  ...
  { question: "What is a 'detention facility'?", answer: "A place to force people to stay", vietnamese: "Nơi giam giữ" },
  ...
  { question: "What is 'weapons training'?", answer: "Learning to use weapons", vietnamese: "Học dùng vũ khí" },
  ...
  { question: "What does 'commit a crime' mean?", answer: "Do something illegally", vietnamese: "Phạm tội" },
  { question: "What does 'offense' mean?", answer: "A minor crime", vietnamese: "Lỗi nhẹ" },
  { question: "What does 'cited' mean?", answer: "Given a ticket by the police", vietnamese: "Bị phạt" },
  ...
  { question: "What is a 'suspended sentence'?", answer: "Delaying sentence", vietnamese: "Hoãn thi hành án" },
  ...
  { question: "What are 'controlled substances'?", answer: "You can buy it with a prescription but limited", vietnamese: "Thuốc kiểm soát" },
  { question: "What is an 'immigration benefit'?", answer: "Things like visa, green card, citizenship.", vietnamese: "Lợi ích nhập cư" },
  ...
  { question: "What does 'pay alimony' mean?", answer: "Pay to ex-spouse after divorce", vietnamese: "Trả cấp dưỡng" },
  { question: "What is a 'public benefit'?", answer: "Welfare, like foodstamps", vietnamese: "Phúc lợi xã hội" },
  { question: "What does 'fraudulent' mean?", answer: "To claim something that is not true", vietnamese: "Gian lận" },
  { question: "What does 'lie' mean?", answer: "Saying something is not true", vietnamese: "Nói dối" },
  { question: "What does 'misleading' mean?", answer: "Gives wrong idea", vietnamese: "Gây hiểu nhầm" },
  { question: "What is 'admission into the US'?", answer: "Allowed to enter US", vietnamese: "Được vào Mỹ" },
  { question: "What are 'deportation proceedings'?", answer: "Process to remove someone", vietnamese: "Thủ tục trục xuất" },
  ...
  { question: "What is a 'hereditary title'?", answer: "The royal title like Prince or Princess", vietnamese: "Tước hiệu truyền đời" },
  { question: "What is the 'Constitution'?", answer: "The supreme law of the land", vietnamese: "Hiến pháp" },
